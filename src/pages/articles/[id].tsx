...
useEffect(() => {
  ...
  <WithNavbar></WithNavbar>
    <div className="flex flex-col justify-center items-center pt-20 bg-gradient-to-b from-dongker via-purple-950/50 to-dongker h-fit">
      ...
      <div>
     <div className="my-20">
     <h1 className="text-left ml-2 mb-6 text-xl border-b-2 w-fit border-white/50">Artikel lainnya</h1>
      ...
      >
        {
          filteredData.length > 0 ? filteredData.map((item: any, index) => (
            <SwiperSlide key={item.id} className="">
              ...
              <div  className={`flex flex-col ${!isDesktop ? 'w-[calc(100%-48px)]' : 'w-[500px]'}  border-[1px] border-white/20 bg-gradient-to-br from-white/20 to-transparent rounded-xl h-[200px] gap-4 p-4`}>
